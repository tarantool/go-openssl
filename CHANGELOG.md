...
The release fixes unavailable GOST ciphers due to a cert/key load.

### Fixed

- The statically linked GOST engine loaded but not initialized or set as
  default, breaking GOST PEM key/certificate decoding (#28).
